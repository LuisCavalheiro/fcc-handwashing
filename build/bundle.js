var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-exi4sz");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-exi4sz");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="handwashing.gif" alt="How to wash your hands." class="svelte-6m0p07">`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
  ...
  <a href="https://freesound.org/people/metrostock99/sounds/345086/ ">
    Sound Source
    			...
    			attr(h1, "class", "svelte-15jpgfh");
    			attr(h3, "class", "svelte-15jpgfh");
    		},
    		m(target, anchor) {
